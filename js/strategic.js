...
Strategic = function(game) {
  this.game = game;
};

Strategic.prototype.nextMove = function() {
...
Strategic.prototype.planAhead = function(grid, numMoves, originalQuality) {
...
Strategic.prototype.chooseBestMove = function(results, originalQuality) {
...
Strategic.prototype.gridQuality = function(grid) {
...
Strategic.prototype.determineGoal = function(grid) {
  var goal = new Goal();
...
Strategic.prototype.determineSubGoal = function(grid, goal) {
...
Strategic.prototype.getDirections = function(vector) {
  directions = [0, 3, -1, -1];
  if (vector.x > 0) {
    directions[0] = 2;
  }
